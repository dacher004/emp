...
<head>
  ...
  <header class="main-header">
    ...
    <nav class="main-nav">
      <ul>
        <li><a href="dephome.php">Home</a></li>
  ...
  <div class="data">
  <form method="POST" action="elistqa.php">
    <label>Search:</label>&nbsp
    <input type="text" name="search" placeholder="Type first name here"> &nbsp
...
// Search and display record from table
  ...
  if (isset($_POST['search'])) {
   ...
   $searchResults = $EmployeeObj->displayDatadep($searchfname);
  } else {
   $searchResults = $EmployeeObj->displayDatadep();
    }
