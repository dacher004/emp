...
<head>
  ...
  <header class="main-header">
    ...
    <nav class="main-nav">
      <ul>
        <li><a href="adminhome.php">Request</a></li>
        <li><a href="elist.php">Account List</a></li>
...
// Search and display record from table
  $searchResults = array();
   $searchResults = $EmployeeObj->Pending();
...
<tr>
  ...
  <td>
            <a href="adminhome.php?approveId=<?php echo $Employee['ID'] ?>" style="color:green" onclick="return confirm('Are you sure want to decline this request?')"> Approve
              </a>&nbsp
            <a href="adminhome.php?declineId=<?php echo $Employee['ID'] ?>" style="color:red" onclick="return confirm('Are you sure want to decline this request?')">
            Decline            </a>
          </td>
...
// Search and display record from table
  $searchResults = array();
  $searchResults = $EmployeeObj->approved();
  foreach ($searchResults as $Employee) {
...
// Search and display record from table
  $searchResults = array();
  $searchResults = $EmployeeObj->Declined();
  foreach ($searchResults as $Employee) {
